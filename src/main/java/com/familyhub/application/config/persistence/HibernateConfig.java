package com.familyhub.application.config.persistence;
...
@EnableJpaRepositories("com.familyhub.application.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.familyhub.application.model");
                for (Class<?> clazz : (new Reflections("com.familyhub.application.model")).getTypesAnnotatedWith(Entity.class)) {
